  ...
  return (
    <div className="map-container relative">
      <motion.div
        ...
        className="absolute bg-black border-[#B7B7B7] border-1 border-solid flex items-center justify-center gap-3 top-12 left-2 md:top-8 md:left-8 w-[60px] rounded-full h-[60px] z-[1000] cursor-pointer"
      >
        <BackSvg />
      </motion.div>
      {!modal ? (
